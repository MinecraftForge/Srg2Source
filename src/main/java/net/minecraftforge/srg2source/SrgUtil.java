...
public class SrgUtil
{
    ...
    public static Map<String, List<String>> readParameterMap(File mcpConfDir, File excFile, boolean applyMap)
    {
        ...
        Map<String, String> methodCsv = readDescriptiveMethodNames(mcpConfDir);
        Map<String, String> paramCsv = readDescriptiveParameterNames(mcpConfDir);
    ...
    public static Map<String, String>[] readMultipleSrgs(List<File> srgs)
    {
        ...
        for (File file : srgs)
        {
            Map<String, String>[] srg = readSrg(file);
     ...
     */
    @SuppressWarnings("unchecked")
    public static Map<String, String>[] readSrg(File srg)
    {
        ...
        final HashMap<String, String> methodSigs = new HashMap<String, String>();
        ...
        return new Map[] { packages, classes, fields, methods, methodSigs };
    }
