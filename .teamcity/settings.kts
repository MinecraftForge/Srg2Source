...
project {
    ...
    features {
        githubIssues {
            id = "Srg2Source__IssueTracker"
            displayName = "MinecraftForge/Srg2Source"
            repositoryURL = "https://github.com/MinecraftForge/Srg2Source"
        }
    }
}
...
object BuildSecondaryBranches : BuildType({
    ...
    id("Srg2Source__BuildSecondaryBranches")
